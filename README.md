...
This is a team project on implementing binary tress in C, its usefulness
and shortcomings as a data structure. 

## Main Header File :file_folder:

* [binary_trees.h](./binary_trees.h): Contains project definitions and
...
## Authors
<details>
    <summary>Trudy Bannerman-Williams</summary>
    <ul>
    <li><a href="https://www.github.com/TrudyB-T">Github</a></li>
    <li><a href="mailto:drtrudybannerman@gmail.com">e-mail</a></li>
    </ul>
</details>
<details>
